...
<footer class="bg-blue-700 pt-20 lg:pt-[120px] pb-10 lg:pb-20 relative z-10">
          ...
          <div class="w-full sm:w-2/3 lg:w-3/12 px-4">
             <div class="w-full mb-10">
                <a
                   ...
                   >
                <img
                   src="https://cdn.tailgrids.com/1.0/assets/images/logo/logo-white.svg"
                   alt="logo"
                   class="max-w-full"
                   />
                </a>
                <p class="text-base text-white mb-7">
             ...
             <div class="w-full mb-10">
                ...
                <div class="flex items-center mb-6">
                   <a
                      ...
                      text-white
                      hover:text-blue-700 hover:bg-white hover:border-white
                      mr-3
                      sm:mr-4
                      lg:mr-3
                      xl:mr-4
