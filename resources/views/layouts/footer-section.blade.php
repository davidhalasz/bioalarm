        ...
        <div class="flex flex-wrap -mx-4">
            <div class="w-full md:w-2/3 lg:w-1/3 px-4">
                <div class="w-full mb-12">
                    <h4 class="font-medium text-3xl xl:text-[32px] text-dark">
                        ...
                        <div>
                            ...
                            <ul>
                                ...
                                <li class="mb-2">
                                    ...
                                    Fióktelep, ami egyben az ÉMOP-1.3.1-12-2012-0053 projekt megvalósítási helyszíne is
                                    volt:<br />
    ...
    <div class="border-t py-8">
       <div class="container">
          <div class="flex items-center flex-wrap -mx-4">
             <div class="w-full lg:w-3/12 xl:w-1/3 px-4">
                <div class="w-full text-center lg:text-left py-3">
             ...
             <div class="w-full md:w-1/2 lg:w-5/12 xl:w-1/3 px-4">
             ...
             <div class="w-full md:w-1/2 lg:w-4/12 xl:w-1/3 px-4">
                <div class="w-full py-3">
                   <div
                      class="flex items-center justify-center lg:justify-end -mx-3"
                      >
                      <a
                         href="javascript:void(0)"
                         class="px-3 text-[#CDCED6] hover:text-primary"
                         >
                         <svg
                            width="10"
                            height="18"
